...
def main():
        ...
        for acc in [True, False]:
            for gyr in [True, False]:
                for near in [True, False]:
                    ...
                    model = tk.LGBM(song + 1, acc, gyr, near, over_sampled=OVER_SAMPLED, label_group=LABEL_GROUP)
    ...
    result_df.to_csv('CSV/lgbm_result_' + LABEL_GROUP + '_' + str(OVER_SAMPLED) + '.csv', index=False)
